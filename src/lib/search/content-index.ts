...
export const searchableContent: SearchableContent[] = [
  ...
  // ============================================
  {
    id: 'resource-executive-summary',
    type: 'guide',
    title: 'Transformation Fund Executive Summary',
    description: 'Quick overview document of the Fund',
    content: "Download the Executive Summary for a concise overview of the Transformation Fund, its objectives, operating model, and impact metrics.",
    url: '/resources/Transformation_Fund_Executive_Summary_v1_29Sept.pdf',
    category: 'general',
    audience: ['general'],
    keywords: ['executive summary', 'document', 'download', 'PDF', 'overview', 'summary'],
    priority: 3,
    lastUpdated: currentDate,
  },
  {
    id: 'resource-full-document',
    type: 'guide',
    title: 'Full Transformation Fund Document',
    description: 'Comprehensive Fund documentation',
    content: "Download the full Transformation Fund document for detailed information on governance, funding mechanisms, eligibility criteria, and implementation plans.",
    url: '/resources/TransformationFundDocument_v2.4_28Sept25.pdf',
    category: 'general',
    audience: ['general'],
    keywords: ['full document', 'documentation', 'download', 'PDF', 'detailed', 'comprehensive'],
    priority: 3,
    lastUpdated: currentDate,
  },
];
