const Footer = () => {
  return (
    <footer className="bg-[#007847] text-white py-16" role="contentinfo" aria-label="Site footer with contact information and social media links">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-green-400 text-center">
          <p className="opacity-75 font-light">&copy; 2024 Transformation Fund. Engineering inclusive growth for South Africa.</p>
        </div>
      </div>
    </footer>
  );
